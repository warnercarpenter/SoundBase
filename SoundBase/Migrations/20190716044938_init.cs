        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatMessage_Project_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProjectInviteId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    DateInvited = table.Column<DateTime>(nullable: false, defaultValueSql: "GETDATE()"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectInvite", x => x.ProjectInviteId);
                    table.ForeignKey(
                        name: "FK_ProjectInvite_Project_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Project",
                        principalColumn: "ProjectId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectInvite_AspNetUsers_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectInvite_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Track_Project_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Project",
                        principalColumn: "ProjectId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectInvite_ProjectId",
                table: "ProjectInvite",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectInvite_ReceiverId",
                table: "ProjectInvite",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectInvite_SenderId",
                table: "ProjectInvite",
                column: "SenderId");
